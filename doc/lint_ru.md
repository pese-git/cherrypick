...
> `cherrypick_lint` показывает те же классы ошибок — плюс несколько рантайм-ловушек, которые кодоген
> не видит, — прямо во время набора кода.
...
- [README cherrypick_lint](../cherrypick_lint/README.md) — полная таблица правил, совместимость, контрибьютинг
- [Аннотации и кодогенерация](annotations_ru.md)
- [Полный туториал](full_tutorial_ru.md)
