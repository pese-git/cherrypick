# Linting your code with cherrypick_lint

[`cherrypick_lint`](../cherrypick_lint) is an [analyzer plugin](https://pub.dev/packages/analysis_server_plugin)
that catches CherryPick API misuse in the IDE and in `dart analyze` — no `build_runner` required. This guide shows what
each rule catches, with a bad/good example, and how to install and configure it.
...
- [cherrypick_lint README](../cherrypick_lint/README.md) — full rule table, compatibility, contributing
- [Annotations & code generation](annotations_en.md)
- [Full tutorial](full_tutorial_en.md)
