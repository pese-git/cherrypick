...
[`cherrypick_lint`](../cherrypick_lint) is a [`custom_lint`](https://pub.dev/packages/custom_lint) plugin
that catches CherryPick API misuse right in the IDE — no `build_runner` required. This guide shows what
