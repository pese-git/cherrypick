...
| [**cherrypick_lint**](https://github.com/pese-git/cherrypick/tree/master/cherrypick_lint) | `custom_lint` plugin that catches CherryPick API misuse (missing `await` on scope disposal, invalid annotation usage, runtime traps) right in the IDE. |
