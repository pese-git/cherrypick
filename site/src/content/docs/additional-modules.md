...
| [**cherrypick_lint**](https://github.com/pese-git/cherrypick/tree/master/cherrypick_lint) | Analyzer plugin that catches CherryPick API misuse (missing `await` on scope disposal, invalid annotation usage, runtime traps) in the IDE and in `dart analyze`. |
