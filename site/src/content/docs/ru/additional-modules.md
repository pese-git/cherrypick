...
| [**cherrypick_lint**](https://github.com/pese-git/cherrypick/tree/master/cherrypick_lint) | Плагин анализатора, ловит неверное использование API CherryPick (пропущенный `await` при закрытии скоупа, неверное применение аннотаций, рантайм-ловушки) в IDE и в `dart analyze`. |
