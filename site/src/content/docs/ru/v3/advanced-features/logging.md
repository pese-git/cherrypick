---
title: Логирование
slug: ru/v3/advanced-features/logging
---
...
Для более гибкого логирования или UI-оверлеев можно использовать observer наподобие [talker\_cherrypick\_logger](https://pub.dev/packages/talker_cherrypick_logger):
