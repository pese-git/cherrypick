...
- Резолв через подскоуп не делает его владельцем: `Disposable` освобождает тот
  скоуп, где объявлен его биндинг (см. [Disposable](../core-concepts/disposable/)).
...
**Совет:** Всегда закрывайте подскоупы, когда они больше не нужны, чтобы освободить ресурсы. Учтите: освобождается то, что объявлено в самом подскоупе — чтобы привязать ресурс к времени жизни подскоупа, объявляйте его биндинг там, а не в родителе.
