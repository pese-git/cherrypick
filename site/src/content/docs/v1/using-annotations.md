---
title: Using Annotations & Code Generation
slug: v1/using-annotations
---
...
* After running build\_runner, the mixin `_ProfilePage` will be generated for field injection.
