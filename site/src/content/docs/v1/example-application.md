...
description: A complete CherryPick 1.x app wiring an API client, repository, and BLoC across scopes.
---

This example wires an API client, a repository, and a simple BLoC across a root
scope and a nested feature scope. It shows named instances, factory providers,
singletons, and sub-scopes working together.
