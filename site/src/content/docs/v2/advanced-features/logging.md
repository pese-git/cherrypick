---
title: Logging
slug: v2/advanced-features/logging
---
...
For richer logging, analytics, or UI overlays, use an advanced observer such as [talker\_cherrypick\_logger](https://pub.dev/packages/talker_cherrypick_logger):
